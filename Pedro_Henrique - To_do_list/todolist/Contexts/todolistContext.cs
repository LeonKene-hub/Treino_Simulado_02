...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Data Source=DESKTOP-3BKCPN3; initial catalog=todolist; user id=sa; pwd=Senai@134; TrustServerCertificate=true;");

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Prioridade>(entity =>
        {
            entity.HasKey(e => e.IdPrioridade).HasName("PK__Priorida__3A85138F46727AF7");
        ...
        {
            entity.HasKey(e => e.IdStatus).HasName("PK__Status__B450643A6135AF20");
        ...
        {
            entity.HasKey(e => e.IdTarefa).HasName("PK__Tarefa__61D038D76F3629B9");
        ...
        {
            entity.HasKey(e => e.IdUsuario).HasName("PK__Usuario__5B65BF976B2625A9");

            entity.ToTable("Usuario");

            entity.HasIndex(e => e.Email, "UQ__Usuario__A9D105343F387AB6").IsUnique();
